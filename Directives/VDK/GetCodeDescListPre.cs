...
const string BPMData_PriceList = "Character08";
const string BPMData_SecondaryPriceList = "Character09";
...
using (var scope = IceContext.CreateDefaultTransactionScope())
{
    ...
    if (!string.IsNullOrEmpty(callContextBpmData[BPMData_PriceList].ToString()) && (decimal)callContextBpmData[BPMData_BaseUnitPrice] <= 0m)
    ...
    if (!string.IsNullOrEmpty(callContextBpmData[BPMData_SecondaryPriceList].ToString()) && !isEURBaseCurrency && (decimal)callContextBpmData[BPMData_SecondCurrencyUnitPrice] <= 0m)
    ...
    //Base Currency
    if (!string.IsNullOrEmpty(callContextBpmData[BPMData_PriceList].ToString()))
    {
        priceListToUpdate.Add(callContextBpmData[BPMData_PriceList].ToString());
        pricesToSet.Add(Convert.ToDecimal(callContextBpmData[BPMData_BaseUnitPrice]));
    }

    //Second Currency
    if (!string.IsNullOrEmpty(callContextBpmData[BPMData_SecondaryPriceList].ToString()))
    {
        priceListToUpdate.Add(callContextBpmData[BPMData_SecondaryPriceList].ToString());
