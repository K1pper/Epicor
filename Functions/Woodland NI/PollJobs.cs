try
{
    if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
    {
        ...
        ***************************************************************/
        ...
        {
            var url = auth.BaseURL + "/job/jobevents/status?createdAt=" + auth.LastPollDate;
            ...
            ***************************************************************/
            ...
            if (jobEventSuccessStatusCode)
            {
                ...
                {
                    var jobList = doc.RootElement.GetProperty("data").EnumerateArray();
                    ...
                    foreach (var job in jobList)
                    {
                        ...
                        ***************************************************************/
                        ...
                        var statusCode = job.GetProperty("statusCode").GetString();
                        ...
                        if (statusCode == "X_PIC")
                        {
                            ...
                            var collectionDate = job.GetProperty("eventTimestamp").GetString();
                            collectDate = DateTime.TryParse(collectionDate, out var dt) ? dt : (DateTime?)null;
                        }
                        ...
                        ***************************************************************/
                        ...
                        this.CallService<Ice.Contracts.UD101SvcContract>(ud101Svc =>
                        {
                            ...
                            {
                                Ice.Diagnostics.Log.WriteEntry("Error updating master pack : " + ex.Message);
                            }
                        });
                    }
                }
